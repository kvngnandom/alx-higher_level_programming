...
During this project, I started maximizing conditionals and loops in Python by employing `if`,
`if ... else`, `break`, `continue`, `pass`, and `range` statements with `while` and
`for` loops. I rehearsed noting my own Python functions while learning about scope of
